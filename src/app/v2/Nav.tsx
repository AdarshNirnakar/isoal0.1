  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex space-x-8 pr-8">
        ...
        <Link href="/v2" className="text-gray-800 hover:text-black font-medium transition-colors">HOME</Link>
        <Link href="/v2/about" className="text-gray-800 hover:text-black font-medium transition-colors">ABOUT</Link>
        <Link href="/v2/faq" className="text-gray-800 hover:text-black font-medium transition-colors">FAQ</Link>
        <Link href="/v2/contact" className="text-gray-800 hover:text-black font-medium transition-colors">CONTACT</Link>
      </div>
      ...
      {isMenuOpen && (
        <div className="absolute top-0 left-0 w-full h-screen bg-white/95 backdrop-blur-lg flex flex-col items-center justify-center space-y-6 md:hidden transition-all duration-300">
          ...
          <Link href="/v2" className="text-gray-800 hover:text-black font-medium text-lg" onClick={() => setIsMenuOpen(false)}>HOME</Link>
          <Link href="/v2/about" className="text-gray-800 hover:text-black font-medium text-lg" onClick={() => setIsMenuOpen(false)}>ABOUT</Link>
          <Link href="/v2/faq" className="text-gray-800 hover:text-black font-medium text-lg" onClick={() => setIsMenuOpen(false)}>FAQ</Link>
          <Link href="/v2/contact" className="text-gray-800 hover:text-black font-medium text-lg" onClick={() => setIsMenuOpen(false)}>CONTACT</Link>
        </div>
      )}
    </nav>
  );
