...
const Websites = () => {
  ...
  const models = [
    ...
    "https://prod.spline.design/wXiyfPbgC3LL44JQ/scene.splinecode",
  ]

  const labels = ["isoal.com", "isoal.ai", "global jobs"]
  ...
  return (
    <div
      id="page3"
      className="min-h-screen w-full flex flex-col md:flex-row items-center justify-center overflow-hidden gap-4 py-16 bg-gradient-to-b from-gray-100 to-white"
    >
      <div className="w-full px-6 mb-12 md:mb-0 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6">Our Digital Ecosystem</h2>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Explore our interconnected platforms designed to maximize your opportunities.
        </p>
      </div>
        ...
        {models.map((src, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center opacity-90 group-hover:opacity-0 transition-opacity duration-500 bg-gradient-to-t from-black via-black/70 to-transparent">
              <span className="text-white text-3xl md:text-5xl font-bold mb-4">{labels[index]}</span>
              <button
